...
<div id="main" role="main">
    <div id="content" class="demo">
        <h3 class="headers red">Resultados de la búsqueda Avanzada </h3>
        ...
        <div class="col-sm-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-xs-12">
                        <h5 class="rage col-xs-6">Desde:</h5>
                        <input type="text" id="from" name="from" class="datapicket col-xs-6 form-control" />
                    </div>
                    <div class="col-xs-12">
                        <h5 class="rage col-xs-6">Hasta:</h5>
                        <input type="text" id="to" name="to" class="datapicket  col-xs-6 form-control"/>
                    </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <ul id="menufecha" class="list-group">
                        <li id="hoy" class="btn-click list-group-item"><a href="#" title="">Hoy</a></li>
                        <li id="semana" class="btn-click list-group-item"><a href="#" title="">Ultima Semana</a></li>
                        <li id="mes" class="btn-click list-group-item"><a href="#" title="">Ultimo Mes</a></li>
                        <li id="ano" class="btn-click list-group-item"><a href="#" title="">Ultimo Año</a></li>
                    </ul>
